...
func NewScriptPool(clusterClient cluster.IClusterClient, rpcclient *rpcclient.RPCClient) (p *ScriptPool, err error) {
	p = &ScriptPool{}
...
func (s *ScriptPool) NewRPCClient() (*rpcclient.RPCClient, error) {
